  ...
  Future<void> GetUserInformation(context) async {
    ...
    if (accessToken == "") {
      ...
      final response = await http.get(
        Uri.parse('http://172.28.187.91:8000/user'),
...
Future<void> GetSpeciesInformation(context, img64) async {
  ...
  if (accessToken == "") {
    ...
    final response = await http.post(
      Uri.parse('http://172.28.187.91:8000/species'),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
        'Authorization': 'Bearer $accessToken'
      },
    ...
    if (response.statusCode == 200) {
      ...
      if(actualSpeciesINfo.isPlant == true){
        Provider.of<Data>(context, listen: false).update(actualSpeciesINfo);
